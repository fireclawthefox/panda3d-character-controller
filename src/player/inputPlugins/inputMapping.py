...
class InputMapping(object):
    ...
    def setDefaultMappingKeyboardAndMouse(self):
        ...
        self.mapButton("reset-Avatar", KeyboardButton.asciiKey(b"r"))
    ...
    def setDefaultMappingGamepadWiiRemote(self):
        ...
        self.mapButton("reset-Avatar", GamepadButton.face_1())
    ...
    def setDefaultMappingGenericGamepad(self):
        ...
        self.mapAxis("jump", InputDevice.Axis.right_trigger)
        self.mapButton("intel-action", GamepadButton.rshoulder())
        self.mapAxis("action1", InputDevice.Axis.right_trigger)
        self.mapAxis("sprint", InputDevice.Axis.left_trigger)
        self.mapButton("walk", GamepadButton.lshoulder())
        self.mapAxis("crouch", InputDevice.Axis.left_trigger)
        self.mapButton("crawl", GamepadButton.face_x())
        self.mapButton("center-camera", GamepadButton.face_b())
        self.mapButton("recalibrate", GamepadButton.back())
        self.mapButton("reset-Avatar", GamepadButton.face_y())
