...
class Plugin():
    ...
    def __init__(self, parent, pid):
        ...
        resetKey = self.parent.deviceMaps[self.parent.selectedDevice].unformatedMapping("reset-Avatar")
    ...
    def getCamButton(self, direction):
        amount = self.parent.deviceMaps[self.parent.selectedDevice].getValue(direction, self.gamepad)
